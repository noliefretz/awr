...
$tempPrefix = 'BB-' . $serial . '_';

// Find tables matching temp prefix.
...
if ( 0 == mysql_num_rows( $tempTables ) ) {
	echo '<h1>Undo Rollback Possibly Incomplete</h1>';
	echo 'No temporary database tables were found matching this serial `' . $serial . '` with prefix `' . $tempPrefix . '`. Did you already accept the rollback OR already finished undoing the rollback? If you refreshed then this may be normal.';
	die();
}
